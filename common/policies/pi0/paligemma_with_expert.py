...
from common.policies.pi0.flex_attention import flex_attention_forward
...
class PaliGemmaWithExpertModel(PreTrainedModel):
    ...
    def get_input_embeddings(self):
        return self.paligemma.get_input_embeddings()

    def get_output_embeddings(self):
        return self.paligemma.get_output_embeddings()

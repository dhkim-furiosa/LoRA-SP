...
class TrainPipelineConfig(HubMixin):
    ...
    # Distributed training mode: 'ddp', 'fsdp', or 'none'
    ...
    def validate(self):
        ...
        if not (self.train_dataset or self.test_dataset or self.dataset):
            raise ValueError("Dataset should be provided for training")
        ...
        if self.method.lora_cfg is None:
